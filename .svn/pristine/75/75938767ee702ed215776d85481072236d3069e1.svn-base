    ...
    return (
      <Switch>
        ...
        <Route exact path ='/apply' render={()=>(
            ...
            <Route exact path="/coursedetails/:courseid" render={(props)=>(
              <CourseDetails {...props} />
              )}
            />
            <Route exact path = "/createcourse/stepone/" render={(props)=>(
              <CreateCourse {...props}/>
              )} 
            />
            ...
            <Route exact path = "/createcourse/stepthree/" render={(props)=>(
              <CourseStepThree {...props}/>
            )} />
            <Route exact path = "/createcourse/stepthree/:courseid" render={(props)=>(
              <CourseStepThree {...props}/>
            )} />
