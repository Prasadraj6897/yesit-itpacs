...
import DATA_SCIENCE_MACHINE_LEARNING from '../img/DATA_SCIENCE_MACHINE_LEARNING.svg'
...
import Pre_requisites_ProfessionalSVG from '../img/Pre_requisites_ProfessionalSVG.svg'
import professional_data_scientist from '../img/professional_data_scientist.svg'

import TableEssentialCriticalDSProf from '../TableEssentialCriticalDSProf'
 class CPDS extends React.Component{
 		...
 		return (
 				<div className='container fluid'>
 					<CardBody>
                        ...
                        <h4 className="card card-body bg-light text-black">Certified Professional Data Scientist (CPDS)®</h4>
                          <p className="px-5 mb-5 pb-3 lead grey-text text-left">The Professional Data Scientist credential is automatically conferred to anyone that has obtained at least 4 Essential certifications and at least 2 critical certifications. The Professional certification is catered to individuals with less more 1 year working experience in the field. This is ideal for already working in this field. Applicants are required to have completed the application process prior to taking the exams. </p>

                          <div className="col-lg-9 pb-3 ml-5 col-sm-12">
                          <img src={professional_data_scientist} className="img-fluid z-depth-0" alt="Certified Professional Data Scientist"></img>
                          </div>

                          <TableEssentialCriticalDSProf />


                          <h4 className="card card-body bg-light text-black">Certified Professional in Data Science (CPDS)®</h4>
                          <p className="px-5 mb-5 pb-3 lead grey-text text-left">The Professional certification is catered to individuals with more than 2 years working experience in the field. This is ideal for people already working in the field looking to obtain certification. Applicants are required to have completed the application process prior to taking the exam. </p>
                          ...
                          <h6>You can choose one or more specializations from the available exams. Your certificate will reflect the specializations which you have passed. Example: Certified Professional in Data Science - Data Visualization.</h6>
                    ...
                    <section>
                        ...
                        <div className="row pt-2">
                          <div className="col-lg-5 text-center text-lg-left">
                            <img src={Pre_requisites_ProfessionalSVG} alt="itpacs" className="img-fluid z-depth-0"></img>
                          </div>
                          <div className="col-lg-7">
                            ...
                            <div className="col-10">
                                <h5 className="font-weight-bold text-left mb-3 dark-grey-text">Proof of concept</h5>
                                <p className="grey-text text-left">Participants are required to show proof of concepts for the deliverbles they have completed. These deliverables need to be accrued over the last 2 years. For team deliverables, the participant needs to demonstrate more than 60% contribution. 
                                </p>
                            </div>
                            </div>
                            ...
                            <div className="col-10">
                                ...
                                <p className="grey-text text-left">Two references are required. References have to be someone directly involved with the work performed by the participant. Example, customer, manager, team member etc.,
                                </p>
                            </div>
                            </div>
                        </div>
          ...
          <section className="py-4 text-center text-lg-left">
            ...
            <div className="row">             
                ...
                <div className="col-lg-9 col-xl-9">                    
                    ...
                    <h3 className="mb-4 font-weight-bold dark-grey-text">
                        <strong>Certified Professional in Data Science - Programming Language</strong>
                    </h3>
                    <p>Data science is the process of extracting useful information from data which involves building and discovering knowledge about the problem domain in a scientifically rigorous manner. Basic programming/coding is an essential skill. Candidates can choose any programming language. Ex, Python, Java etc.,</p>
                     <ListGroup>
                        <ListGroupItem active>Professional must have knowledge of: </ListGroupItem>
            ...
            <div className="row">           
                <div className="col-lg-9 col-xl-9 pb-3">                   
                       <h6 className="font-weight-bold pb-1 blue-text">
                        <i className="fa fa-adjust"></i> Data Science</h6>
                        <h3 className="mb-4 font-weight-bold dark-grey-text">
                          <strong>Certified Professional in Data Science - Data Acquisition</strong>
                      </h3>
            ...
            <div className="row pb-5">                
                ...
                <div className="col-lg-9 col-xl-9">                   
                      ...
                      <i className="fa fa-adjust"></i> Data Science</h6>
                      <h3 className="mb-4 font-weight-bold dark-grey-text">
                        <strong>Certified Professional in Data Science - Data Cleaning</strong>
                      </h3>
            ...
            <div className="row">           
                <div className="col-lg-9 col-xl-9 pb-3">                   
                       <h6 className="font-weight-bold pb-1 blue-text">
                        <i className="fa fa-adjust"></i> Data Science</h6>
                        <h3 className="mb-4 font-weight-bold dark-grey-text">
                          <strong>Certified Professional in Data Science - Data Analysis</strong>
                      </h3>
            ...
            <div className="row pb-5">                
                ...
                <div className="col-lg-9 col-xl-9">                   
                      ...
                      <i className="fa fa-adjust"></i> Data Science</h6>
                      <h3 className="mb-4 font-weight-bold dark-grey-text">
                        <strong>Certified Professional in Data Science - Data Visualization</strong>
                      </h3>
            ...
            <div className="row">           
                <div className="col-lg-9 col-xl-9 pb-3">                   
                       <h6 className="font-weight-bold pb-1 blue-text">
                        <i className="fa fa-adjust"></i> Data Science</h6>
                        <h3 className="mb-4 font-weight-bold dark-grey-text">
                          <strong>Certified Professional in Data Science - Machine Learning Basics</strong>
                      </h3>
            ...
            <div className="row pb-5">                
                ...
                <div className="col-lg-9 col-xl-9">                   
                      ...
                      <i className="fa fa-adjust"></i> Data Science</h6>
                      <h3 className="mb-4 font-weight-bold dark-grey-text">
                        <strong>Certified Professional in Data Science - Non-Linear Supervised Learning Algorithms</strong>
                      </h3>
            ...
            <div className="row">           
                <div className="col-lg-9 col-xl-9 pb-3">                   
                       <h6 className="font-weight-bold pb-1 blue-text">
                        <i className="fa fa-adjust"></i> Data Science</h6>
                        <h3 className="mb-4 font-weight-bold dark-grey-text">
                          <strong>Certified Professional in Data Science - Unsupervised Learning Algorithms</strong>
                      </h3>
            ...
            <div className="row pb-5">                
                ...
                <div className="col-lg-9 col-xl-9">                   
                      ...
                      <i className="fa fa-adjust"></i> Data Science</h6>
                      <h3 className="mb-4 font-weight-bold dark-grey-text">
                        <strong>Certified Professional in Data Science - Clustering Algorithms</strong>
                      </h3>
            ...
            <div className="row">           
                <div className="col-lg-9 col-xl-9 pb-3">                   
                       <h6 className="font-weight-bold pb-1 blue-text">
                        <i className="fa fa-adjust"></i> Data Science</h6>
                        <h3 className="mb-4 font-weight-bold dark-grey-text">
                          <strong>Certified Professional in Data Science - Deep Learning</strong>
                      </h3>
                ...
                <div className="col-lg-4 col-md-12 mb-4">                    
                    ...
                    <Card reverse>
                      ...
                      <CardBody>
                        ...
                        <CardText>Professional certifications are for those with more than 2 years experience in a specific field. </CardText>
                        <hr className="my-2 grey" />                            
                              <h6>Duration:<Badge color="danger" className='ml-1'>120 minutes</Badge></h6>
                              <h6>Format: <Badge color="danger" className='ml-1'>Online/Paper based</Badge></h6>
                              <h6>No of Questions: <Badge color="danger" className='ml-1'>60. (MCQs, Code)</Badge></h6>
                          ...
                          <CardImage className="img-fluid" src={ExamDetails_TestRetake} />
                            <CardBody>
                              ...
                              <CardText>
                                ...
                                improvement to help you prepare better for the next attempt. You can take the Professional exam a maximum of 3 
                          ...
                          <CardImage className="img-fluid" src={ExamDetails_Maintaining} />
                            <CardBody>
                              ...
                              <CardText className="dark-grey-text">
                                To maintain your credential, you will need to accumulate 60 Professional Training Units 
                                (1 PTU = 1 hr of training) over 2 years. Training can be through classroom sessions, e-learning, web learning etc, 20 P.T.Us can be accrued for knowledge sharing activities such as providing training.
                              </CardText>
                              <hr className="my-2 grey" />                            
                              <h6>Accrue PTUs:<Badge color="success" className='ml-1'>60</Badge></h6>
