...
import Pre_requisites_LeaderSVG from '../img/Pre_requisites_LeaderSVG.svg'
 ...
 class CLMD extends React.Component{
 	...
 	render(){
 		return (
 				<div className='container fluid'>
 					<CardBody>
                          <h4 className="card card-body bg-light text-black">Certified Leader in Mobile Development (CLMD)®</h4>
                    ...
                    <ListGroup>
                      ...
                      <ListGroupItem>Overview of Native Applications for Android Platform<Badge className='ml-2'>Essential</Badge></ListGroupItem>
                      <ListGroupItem>Overview Native Applications for iOS Platform<Badge className='ml-2'>Essential</Badge></ListGroupItem>
                      <ListGroupItem>Request-Response cycle<Badge className='ml-2'>Essential</Badge></ListGroupItem>
                      <ListGroupItem>Overview of Hybrid applications <Badge className='ml-2'color='info'>Critical</Badge></ListGroupItem>
                      <ListGroupItem>Overview of Progressive Web Applications<Badge className='ml-2'color='info'>Critical</Badge></ListGroupItem>
          ...
          <section className="py-4 text-center text-lg-left">
            ...
            <div className="row">           
                ...
                <div className="col-lg-3 col-xl-3">                     
                    <div className="view overlay rounded z-depth-2">
                        <img src={MOBILE_DEV_COMMUMICATION_OVER_WEB} alt="itpacs" className="img-fluid z-depth-0"></img>
