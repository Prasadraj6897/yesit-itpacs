...
import Pre_requisites_ProfessionalSVG from '../img/Pre_requisites_ProfessionalSVG.svg'
 ...
 class CPMD extends React.Component{
 	...
 	render(){
 		return (
 				<div className='container fluid'>
 					<CardBody>
                          <h4 className="card card-body bg-light text-black">Certified Professional in Mobile Development (CPMD)®</h4>
          ...
          <section className="py-4 text-center text-lg-left">
            ...
            <div className="row">           
                ...
                <div className="col-lg-3 col-xl-3">                     
                    <div className="view overlay rounded z-depth-2">
                        <img src={MOBILE_DEV_CONTEXT} alt="itpacs" className="img-fluid z-depth-0"></img>
