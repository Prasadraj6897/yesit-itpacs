...
import { MDBContainer, MDBRow, MDBCol, MDBCard, MDBCardBody, MDBInput, MDBBtn, MDBIcon, MDBFileInput, MDBModalFooter } from 'mdbreact';
...
class MyEditor extends React.Component {
  ...
  handleSave = data => {
    ...
    if(this.state.imgSelected == false)
      ...
      axios({
        url: `${process.env.REACT_APP_COURSES_SERVICE_URL}/courses/uploadImageToS3`,
        method: 'POST',
        data:{imageData:b64Data, imageType:type, imageBorder:imgBorder},
        headers:{
          ...
          this.props.SetCourseLogoPath(response.data.url, imgBorder)
      })
        ...
        <MDBRow>
          ...
          <MDBCol lg="8">
            <MDBFileInput id="fileUploadId" getValue={this.handleNewImage} btnColor="info" btn-size="sm" />
              ...
              <br />
              <hr />
              <MDBBtn color="primary" onClick={this.handleSave} rounded size="sm">Upload</MDBBtn>
              <MDBBtn color="danger" rounded size="sm">Close</MDBBtn>
              <br />
          </MDBCol>
        </MDBRow>
      </div>
