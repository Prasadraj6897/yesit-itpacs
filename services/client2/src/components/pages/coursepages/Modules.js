...
class Modules extends React.Component{
	...
	removeCourseModule(modId){
		const moduleid = modId

		const options = {
	      url: `${process.env.REACT_APP_COURSES_SERVICE_URL}/courses/removeCourseModule`,
	      method: 'post',
									...
									<li class="list-group-item">
										<div>
											...
											<div style={{'width':'20%'}} className="fleft">
												...
												<MDBIcon icon="trash" onClick={this.removeCourseModule.bind(this, mid)}></MDBIcon>
											</div>
										</div>
									</li>
								)
